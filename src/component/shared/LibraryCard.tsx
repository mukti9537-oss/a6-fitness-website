...
const LibraryCard = ({ library }: LibraryCardProps) => {
    return (
        <Link 
            ...
            className="group block bg-[#000000] rounded-2xl overflow-hidden border border-[#20242E]  
            hover:shadow-xl transition-all duration-300 hover:-translate-y-1 hover:border-[#C2F800]"
        >
            <article>
